...
public class MybatisPageInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		if (invocation.getTarget() instanceof StatementHandler) { // 控制SQL和查询总数的地方
			...
			Pageable page = findPageObject(parameterObj);
			...
			if (page.getTotalPage() > -1) {
				...
				queryTotalCount(page, parameterObj, mappedStatement, connection);
			}
			...
			if (page != null && resultObj instanceof List) {
				PageImpl pageImpl = new PageImpl();
				pageImpl.setPage(page.getPage());
				pageImpl.setPageSize(page.getPageSize());
				pageImpl.setTotalPage(page.getTotalPage());
				pageImpl.setTotal(page.getTotal());
				pageImpl.setNext(page.getNext());
				pageImpl.addAll((List) resultObj);
...
//				}
	 ...
	 * @return
	 */
	protected String buildMysqlPageSql(Pageable page, String sql) {
	 ...
	 * @return
	 */
	protected String buildOraclePageSql(Pageable page, String sql) {
	 ...
	 * @throws SQLException
	 */
	protected void queryTotalCount(Pageable page, Object parameterObject, MappedStatement mappedStatement, Connection connection) throws SQLException {
